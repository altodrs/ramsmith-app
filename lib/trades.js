export const trades = [
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Vehicles / Traffic on Driveways",
        control:
          "Position the work area away from vehicle manoeuvring routes where possible, and use cones or barriers to warn drivers of the work in progress on domestic driveways or car parks.",
      },
      {
        name: "RCD/RCBO Protection Device Testing",
        control:
          "Test and commission the dedicated RCD/RCBO protection device before handover, confirming correct trip times in line with BS 7671 requirements for EV charging circuits.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working in Confined Airing Cupboards/Under-Stairs Spaces",
        control:
          "Use adequate task lighting and ensure good ventilation when working in a confined airing cupboard or under-stairs boiler location.",
      },
      {
        name: "Condensate Pipe Freezing & Water Damage",
        control:
          "Route and lag the condensate discharge pipe to the manufacturer's specification to prevent freezing and consequent boiler lockout or water escape.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      },
      {
        ...
        control:
          "Monitor wind speed and weather forecasts throughout the day, and stop roof work immediately if wind, rain or ice make the roof surface unsafe.",
      },
      {
        name: "Fragile Roof Lights & Coverings",
        control:
          "Identify and clearly mark any fragile roof lights or coverings before work begins, using crawl boards or staging to distribute weight and avoid stepping directly on fragile areas.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manual Handling of Scaffold Tubes & Boards",
        control:
          "Team-lift or use a gin wheel/hoist for heavy scaffold tubes, fittings and boards, avoiding repetitive manual carrying up access ladders.",
      },
      {
        name: "Adverse Weather During Erection/Dismantling",
        control:
          "Suspend erection or dismantling work in high winds, ice or heavy rain, and secure partially erected structures before leaving site.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Overhead Power Lines/Cables",
        control:
          "Identify and maintain safe clearance from any overhead electrical service cables before positioning ladders or towers near the property.",
      },
      {
        name: "Manual Handling of Access Equipment",
        control:
          "Use correct lifting technique and, where possible, a second person when carrying and erecting ladders or tower sections around the property.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Plant & Excavator Movement Near the Trench",
        control:
          "Segregate the excavator's swing radius from pedestrian routes with barriers, and use a banksman for all machine movements near the open trench.",
      },
      {
        name: "Ingress of Water into the Excavation",
        control:
          "Monitor for groundwater ingress and use a pump to keep the excavation free of standing water, reassessing trench stability if water is present.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working in an Occupied Domestic Kitchen",
        control:
          "Isolate the electricity and water supply to existing appliances before disconnection, and keep the work area segregated from household members during the fit.",
      },
      {
        name: "Hand-Arm Vibration from Power Tools",
        control:
          "Limit continuous trigger time on vibrating tools such as jigsaws and routers, and rotate tasks between operatives to manage daily HAVS exposure.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Handling Hot Components During Servicing",
        control:
          "Allow the appliance to cool before removing casings or handling heat exchangers, and wear heat-resistant gloves when handling hot components.",
      },
      {
        name: "Electrical Isolation of the Appliance",
        control:
          "Isolate the electrical supply to the boiler before removing any casing or accessing internal components, testing dead before touching electrical parts.",
      },
    ],
    required_ppe: [
      "Nitrile Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Skin Contact with Wet Plaster",
        control:
          "Wear waterproof gloves when mixing and applying wet plaster to prevent skin irritation and cement-type burns from prolonged contact.",
      },
      {
        name: "Slips on Plaster Spillage/Wet Floors",
        control:
          "Clean up plaster spillage and mixing residue promptly, and use protective floor coverings to prevent slip hazards in the work area.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Kneeling & Repetitive Strain During Floor Tiling",
        control:
          "Use knee pads and a kneeling mat for floor tiling work, and take regular breaks to reduce repetitive strain from prolonged kneeling.",
      },
      {
        name: "Silica Dust from Dry-Cutting Tiles",
        control:
          "Use water-fed or dust-extracted cutting equipment in preference to dry-cutting, and wear an FFP3 mask where dry-cutting cannot be avoided, in line with HSE guidance on respirable crystalline silica.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Boundaries & Neighbouring Property",
        control:
          "Confirm boundary lines before digging or erecting fencing, and agree access with neighbouring property owners where work may affect a shared boundary.",
      },
      {
        name: "Concrete Mixing & Handling",
        control:
          "Wear waterproof gloves and eye protection when mixing and handling postcrete or concrete, following the COSHH data sheet for cement-based products.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Existing Structures & Services",
        control:
          "Locate existing drains, cables and buried services before excavating for a patio base, using a CAT & Genny scan where service positions are uncertain.",
      },
      {
        name: "Manual Handling of Turf & Green Waste",
        control:
          "Use correct lifting technique and mechanical aids where possible when removing turf, soil and green waste from the site.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      },
      {
        ...
        control:
          "Identify and maintain safe clearance from any overhead electrical service cables before positioning ladders, scaffolding or lifting equipment near the roof.",
      },
      {
        name: "Fixing Roof Anchors & Penetrations",
        control:
          "Identify rafter positions before drilling roof anchor points, and seal all roof penetrations correctly to prevent water ingress.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Disposal of Broken/Damaged Glazing Units",
        control:
          "Store broken glass in a dedicated, clearly marked container away from walkways, and dispose of it via a licensed waste carrier.",
      },
      {
        name: "Working Near Occupied Rooms During Removal",
        control:
          "Screen off the work area from occupied rooms during frame and glass removal, and clear the immediate area of furniture and occupants.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Verifying Legitimate Access Before Entry",
        control:
          "Confirm the caller's identity and right of access to the property before carrying out any lock change or forced entry work.",
      },
      {
        name: "Manual Handling of Replacement Doors & Locks",
        control:
          "Use correct lifting technique when handling replacement doors, frames and heavy security hardware.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "False Alarm Activation During Testing",
        control:
          "Notify the building's responsible person and monitoring station before testing to prevent an unwanted call-out or evacuation, and confirm the system is reset correctly afterwards.",
      },
      {
        name: "Manual Handling & Cable Routing in Ceiling Voids",
        control:
          "Use adequate task lighting and check for asbestos-containing materials before disturbing ceiling tiles in older buildings when routing cabling.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Wet Weather & Ground Conditions on New Build Sites",
        control:
          "Assess ground conditions before positioning materials and access equipment, and suspend work in heavy rain that could affect mortar quality or scaffold stability.",
      },
      {
        name: "Manual Handling of Lintels & Padstones",
        control:
          "Use mechanical lifting aids or a minimum two-person lift for heavy lintels and padstones, keeping loads close to the body.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Dust Generation During Strip-Out",
        control:
          "Use dust suppression (damping down) and dust extraction on cutting/breaking tools, and wear an FFP3 mask throughout strip-out work.",
      },
      {
        name: "Hidden Services in Walls & Floors",
        control:
          "Check for live electrical, gas and water services before breaking into walls or floors, isolating any services found before continuing.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Kneeling & Repetitive Strain During Installation",
        control:
          "Use knee pads and take regular breaks during prolonged kneeling or crouching while laying flooring.",
      },
      {
        name: "Removing Existing Floor Coverings (Legacy Materials)",
        control:
          "Treat older adhesives and floor tiles as potentially containing asbestos until tested, and avoid dry sanding or grinding legacy floor coverings.",
      },
    ],
    required_ppe: [
      "Cut-Resistant Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Cavity Wall Drilling & Injection",
        control:
          "Check the wall construction and cavity width before drilling injection points, and follow the manufacturer's spacing pattern to ensure full cavity fill.",
      },
      {
        name: "Disturbing Existing Electrical Cabling in the Loft",
        control:
          "Identify and avoid existing electrical cabling when laying insulation over joists, reporting any damaged or exposed wiring found.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Weather Sensitivity of Render Application",
        control:
          "Monitor temperature and rainfall forecasts, and avoid applying render in frost conditions or immediately before heavy rain, in line with the manufacturer's application guidance.",
      },
      {
        name: "Dust from Mixing Dry Render/K-Rend Products",
        control:
          "Wear an FFP3 mask when tipping and mixing dry render bags, and mix in a well-ventilated area where possible.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working in Occupied Domestic Properties",
        control:
          "Screen off the work area from occupied rooms and ventilate the property throughout treatment, particularly when applying injection creams or tanking slurries.",
      },
      {
        name: "Manual Handling of Injection Equipment & Materials",
        control:
          "Use correct lifting technique for tanking slurry bags and injection equipment, and position materials to minimise carrying distance in confined cellar spaces.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Condensate Drainage & Water Damage",
        control:
          "Route and test the condensate drain line before handover to prevent water leaks or damage to the property.",
      },
      {
        name: "Manual Handling of Indoor & Outdoor Units",
        control:
          "Use mechanical lifting aids or a two-person lift for indoor and outdoor unit bodies, particularly when mounting outdoor units at height.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Wildlife & Nesting Bird Considerations",
        control:
          "Check for nesting birds or protected species before felling or pruning during bird nesting season, in line with the Wildlife and Countryside Act 1981.",
      },
      {
        name: "Working Near Overhead Power Lines & Structures",
        control:
          "Identify overhead power lines and nearby structures before felling, maintaining safe clearance distances and adjusting the felling plan accordingly.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working with Existing Plumbing & Water Isolation",
        control:
          "Isolate the water supply before disconnecting existing sanitaryware, and confirm no leaks are present before proceeding with removal.",
      },
      {
        name: "Electrical Safety Near Wet Areas",
        control:
          "Install and connect any electrical fittings (extractor fans, shaver sockets) in line with BS 7671's special locations requirements for bathrooms (Section 701).",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manual Handling of Ladders & Access Equipment",
        control:
          "Use correct lifting technique and, where possible, a second person when carrying and positioning ladders or towers around the property.",
      },
      {
        name: "Data & Power Cable Routing",
        control:
          "Route and secure cabling away from foot traffic and pinch points, keeping low-voltage and mains cabling appropriately separated.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Dust from Chasing Walls for Cabling",
        control:
          "Use dust extraction on chasing tools and wear an FFP3 mask when cutting chases into plaster or masonry walls.",
      },
      {
        name: "Disruption to Occupants During a Live-In Rewire",
        control:
          "Agree a room-by-room sequence with the occupant, maintaining power to essential circuits where possible and confirming isolation times in advance.",
      },
    ],
    required_ppe: [
      "1000V Insulated Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Interpreting Test Results & Reporting C1/C2 Defects",
        control:
          "Immediately advise the client of any Code C1 (danger present) defect found, and make the installation safe or recommend isolation before leaving site.",
      },
      {
        name: "Working on Aged or Unknown Installations",
        control:
          "Treat any installation of unknown age or history as potentially non-standard, checking cable colours and circuit identification carefully before testing.",
      },
    ],
    required_ppe: [
      "1000V Insulated Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Hot Works & Torch-Applied Membrane Fire Risk",
        control:
          "Follow a hot work permit procedure when torch-applying membrane, keeping a fire extinguisher and fire watch in place during and after work, in line with FRA/RISCAuthority guidance.",
      },
      {
        name: "Fragile Roof Areas & Roof Lights",
        control:
          "Identify and mark any fragile roof lights or areas before work begins, using crawl boards or staging to distribute weight safely.",
      },
    ],
    required_ppe: [
      "Fall Arrest Harness (BS EN 361)",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manual Handling of Fascia & Soffit Boards at Height",
        control:
          "Use a lifting line or pass boards hand-to-hand up secured access equipment rather than carrying long boards up ladders single-handed.",
      },
      {
        name: "Bird Nests & Pest Infestation in Guttering",
        control:
          "Check for nesting birds or wasp nests before removing old guttering, and follow the appropriate procedure if an active nest is found.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Plant & Vehicle Movement on Domestic Driveways",
        control:
          "Use a banksman for mini-digger or dumper movements on domestic driveways, and keep pedestrians and vehicles clear of the working area.",
      },
      {
        name: "Weather Sensitivity of Resin Application",
        control:
          "Check temperature and rainfall forecasts before mixing and laying resin-bound surfacing, following the manufacturer's application window.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working at Height on the External Scaffold/Roof",
        control:
          "Use a properly erected scaffold with edge protection for external roof alterations and dormer construction above 2m.",
      },
      {
        name: "Dust & Debris from Structural Alteration Work",
        control:
          "Use dust extraction and sheeting to contain dust and debris within the work area, protecting the rest of the occupied property.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "RPE Fit & Face Fit Testing",
        control:
          "Confirm all operatives have a current, in-date face fit test for the specific RPE model used, and check the face seal before each entry into the work area.",
      },
      {
        name: "Air Monitoring & Clearance Testing",
        control:
          "Carry out air monitoring during and clearance testing after licensed works, in line with HSE guidance HSG248, before the area is handed back for reoccupation.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Chimney Stack Condition & Fixing Points",
        control:
          "Inspect the chimney stack or fixing point for structural soundness and loose brickwork before attaching aerial or dish mounting brackets.",
      },
      {
        name: "Adverse Weather During Roof-Level Work",
        control:
          "Monitor wind speed throughout the job and stop roof-level work if conditions make the aerial or dish difficult to control safely.",
      },
    ],
    required_ppe: [
      "Fall Arrest Harness (BS EN 361)",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Around Children & Pets on Domestic Sites",
        control:
          "Confirm children and pets are kept away from treated areas and bait stations, using tamper-resistant stations where domestic access is possible.",
      },
      {
        name: "Manual Handling of Traps & Bait Station Equipment",
        control:
          "Use correct lifting technique when carrying and positioning bait stations and equipment around the site.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Outside Own Competence",
        control:
          "Do not undertake work outside the operative's training or competence (e.g. gas, electrical or structural work) — refer such tasks to an appropriately qualified/registered trade.",
      },
      {
        name: "Working in Occupied Domestic Properties",
        control:
          "Keep the work area tidy and tools secured away from children and pets when working in an occupied home.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manifold & Zone Valve Commissioning",
        control:
          "Balance and commission each heating zone at the manifold before handover, labelling zones clearly for the end user.",
      },
      {
        name: "Working on Suspended Timber Floors",
        control:
          "Check joist positions and floor loading before cutting into a suspended timber floor to route pipework, avoiding notching load-bearing joists excessively.",
      },
    ],
    required_ppe: [
      "Knee Pads",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Electrical Hazards from Water-Damaged Areas",
        control:
          "Treat any electrical fittings or sockets near the leak as unsafe until isolated and inspected, particularly ceiling roses and downlights affected by water ingress.",
      },
      {
        name: "Working at Height to Access Leak Sources",
        control:
          "Use appropriate access equipment rather than furniture when tracing leaks at ceiling level or in loft spaces.",
      },
    ],
    required_ppe: [
      "Nitrile Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Around Furniture & Occupied Rooms",
        control:
          "Protect and move furniture clear of the work area, and use dust sheets to protect flooring and fittings in occupied rooms.",
      },
      {
        name: "Lead Paint in Older Properties",
        control:
          "Assume painted surfaces in pre-1960s properties may contain lead unless tested otherwise, avoiding dry sanding and using wet methods or chemical stripping instead.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Recording & Communicating Inspection Findings",
        control:
          "Complete the scaffold inspection record (or equivalent) accurately and immediately communicate any defect found to the site manager before the scaffold is used.",
      },
      {
        name: "Adverse Weather Affecting Inspection",
        control:
          "Postpone external inspection in high winds or icy conditions where the scaffold itself cannot be safely accessed.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Ventilation & Location of the Battery Unit",
        control:
          "Install the battery in a location meeting the manufacturer's ventilation, temperature and clearance requirements, avoiding cupboards or areas with restricted airflow.",
      },
      {
        name: "Interfacing with Existing Solar PV/Inverter Systems",
        control:
          "Confirm compatibility with the existing inverter and PV system before connection, and isolate both systems before making any new electrical connections.",
      },
    ],
    required_ppe: [
      "1000V Insulated Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Existing Building Foundations",
        control:
          "Assess the risk of undermining neighbouring structures before excavating close to existing foundations, seeking engineer input where required.",
      },
      {
        name: "Manual Handling of Reinforcement & Formwork",
        control:
          "Use mechanical lifting aids or team-lift for steel reinforcement bars and formwork, keeping loads close to the body.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Temporary Access During Installation",
        control:
          "Provide a safe temporary access route (e.g. a ladder or temporary treads) for other trades while the permanent staircase is incomplete.",
      },
      {
        name: "Balustrade & Handrail Compliance",
        control:
          "Install balustrades and handrails to Building Regulations Part K spacing and height requirements before the staircase is signed off for use.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Chimney Stack Structural Stability",
        control:
          "Assess the stack for structural movement or instability before working on or near it, and stop work if unexpected movement is observed.",
      },
      {
        name: "Adverse Weather at Ridge Height",
        control:
          "Monitor wind speed throughout the day and stop ridge-level work if conditions make the work area unsafe.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      },
      {
        ...
        control:
          "Secure gas cylinders upright with a chain or stand, and check hoses and regulators for damage before use.",
      },
      {
        name: "Manual Handling of Steel Sections & Fabrications",
        control:
          "Use mechanical lifting aids or a team lift for heavy steel sections, keeping fingers clear of pinch points when positioning fabrications.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Above Public Pedestrians & Shoppers",
        control:
          "Barrier off and signpost the work area at ground level whenever working above an active public footway or shopping street.",
      },
      {
        name: "Wind Loading on Large Sign Panels",
        control:
          "Check wind conditions before lifting or fitting large, low-density sign panels, as they act as sails and can be difficult to control in gusts.",
      },
    ],
    required_ppe: [
      "Fall Arrest Harness (BS EN 361)",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "LPG/Oil Tank Siting & Fire Separation",
        control:
          "Position the fuel tank in line with the manufacturer's and OFTEC/LPGA fire separation distances from boundaries, openings and ignition sources.",
      },
      {
        name: "Bunding & Spill Containment",
        control:
          "Confirm the fuel tank has adequate bunding or spill containment in line with environmental regulations before commissioning.",
      },
    ],
    required_ppe: [
      "Nitrile Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Fire-Rated Partition Compliance",
        control:
          "Install fire-rated plasterboard systems strictly to the specified board layers and fixing pattern where a fire rating is required.",
      },
      {
        name: "Cutting Plasterboard in Confined Rooms",
        control:
          "Cut plasterboard in a ventilated area or outdoors where possible, using a dust-extracted saw or hand tools to limit dust in confined rooms.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Ground Preparation & Sub-Base Stability",
        control:
          "Assess ground conditions and install adequate sub-frame support/footings before decking is laid, particularly on sloped or soft ground.",
      },
      {
        name: "Weather-Related Slip Risk on Composite Decking",
        control:
          "Allow adequate curing/settling time and check manufacturer guidance on slip resistance for composite boards, particularly in wet conditions.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Weed Membrane & Adhesive Handling",
        control:
          "Follow the COSHH data sheet for jointing adhesives and tapes used to seam artificial grass rolls, ensuring adequate ventilation.",
      },
      {
        name: "Working Near Existing Garden Features",
        control:
          "Identify and protect existing garden features, drainage and irrigation systems before excavating the sub-base.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Sealing & Weatherproofing New Frames",
        control:
          "Seal all frame-to-wall junctions correctly on completion to prevent water ingress, following the manufacturer's installation guidance.",
      },
      {
        name: "Disposal of Old Frames & Glazing",
        control:
          "Store removed frames and broken glazing safely away from walkways, and dispose of them via a licensed waste carrier.",
      },
    ],
    required_ppe: [
      "Glass-Handling Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Electrical Consumer Units",
        control:
          "Maintain safe clearance from the electrical consumer unit when routing pipework, and isolate power if working in close proximity.",
      },
      {
        name: "System Commissioning & Testing",
        control:
          "Commission and test the softener/filtration system for correct regeneration and flow before handover, checking for leaks at all new joints.",
      },
    ],
    required_ppe: [
      "Nitrile Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Groundwater & Buoyancy Risk to the Tank",
        control:
          "Assess groundwater levels before installation and anchor or ballast the tank as specified by the manufacturer to prevent flotation.",
      },
      {
        name: "Percolation Testing & Soakaway Siting",
        control:
          "Confirm percolation test results and soakaway siting distances from buildings, boundaries and watercourses in line with Building Regulations Part H before installation.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working at Height for Flue/Chimney Installation",
        control:
          "Use appropriate roof access equipment when installing or connecting flue liner at chimney or roof level.",
      },
      {
        name: "Building Regulations Notification",
        control:
          "Notify the installation to Building Control or via a competent person scheme (HETAS) and issue the relevant certificate before handover.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manual Handling of Concrete & Reinforcement in Bays",
        control:
          "Use mechanical aids or team-lift for concrete, reinforcement and formwork moved into excavated underpinning bays.",
      },
      {
        name: "Monitoring Adjacent Structures & Services",
        control:
          "Monitor adjacent structures, drains and services for movement throughout the works, using survey points where movement risk is significant.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Weather Sensitivity of Roof Glazing Work",
        control:
          "Monitor wind and rain forecasts before lifting and fitting roof glazing panels, as they are large, wind-sensitive components.",
      },
      {
        name: "Foundation & Base Excavation",
        control:
          "Conduct a CAT & Genny scan before excavating for the base slab or footings, and check ground conditions before pouring.",
      },
    ],
    required_ppe: [
      "Fall Arrest Harness (BS EN 361)",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Wind Loading & Weather Sensitivity During Fixing",
        control:
          "Check wind speed forecasts before lifting and fixing large, lightweight cladding panels, which are particularly sensitive to gusts at height.",
      },
      {
        name: "Sealing & Weatherproofing Panel Joints",
        control:
          "Seal all panel joints and penetrations correctly to the system specification to prevent water ingress behind the cladding.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working in Occupied Rooms with Open Fireplaces",
        control:
          "Sheet and seal the fireplace opening before sweeping to contain soot and dust, protecting furnishings and flooring in the room.",
      },
      {
        name: "Bird Nests & Debris Obstructing the Flue",
        control:
          "Check for nesting birds or debris obstructing the flue before sweeping, and follow the appropriate procedure if an active nest is found.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Live Overhead Power Lines",
        control:
          "Identify and maintain safe clearance from overhead power lines before positioning cranes or lifting steel sections nearby.",
      },
      {
        name: "Adverse Weather During Lifting Operations",
        control:
          "Suspend crane lifting operations in high winds exceeding the crane or component's rated limits.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Edge Restraint & Kerb Installation",
        control:
          "Install edge restraints and kerbs before laying tarmac to contain the material and prevent edge slumping.",
      },
      {
        name: "Working Near Existing Driveways/Access Routes",
        control:
          "Maintain a safe alternative access route for residents and vehicles while the driveway surface cures.",
      },
    ],
    required_ppe: [
      "Heat-Resistant Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manual Handling of Pool Shell Components & Plant",
        control:
          "Use mechanical lifting aids for heavy pool shell panels, filtration plant and pumps, team-lifting where mechanical aids aren't practical.",
      },
      {
        name: "Groundwater & Structural Buoyancy Risk",
        control:
          "Assess groundwater levels before excavation and manage dewatering during the build to prevent shell flotation before backfilling.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "System Commissioning & Fail-Safe/Fail-Secure Testing",
        control:
          "Test and confirm the correct fail-safe or fail-secure operation of each door on power loss before handover, particularly on fire escape routes.",
      },
      {
        name: "Working Near Existing Security & Fire Systems",
        control:
          "Confirm interaction with any existing fire alarm or security system before wiring, avoiding unintended interference with life safety systems.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Fire-Stopping of Cable Penetrations",
        control:
          "Fire-stop all cable penetrations through fire-rated walls and floors to the specification, restoring compartmentation on completion.",
      },
      {
        name: "Working Near Existing Live Services in Risers",
        control:
          "Identify existing live electrical and data services in risers before working, maintaining safe separation between new and existing cabling.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Weather Sensitivity of Panel Assembly",
        control:
          "Monitor wind conditions before lifting and fitting large wall and roof panels, which are wind-sensitive during assembly.",
      },
      {
        name: "Electrical Supply Connection to the Outbuilding",
        control:
          "Install any electrical supply run to the garden room to BS 7671 requirements, with appropriate cable protection and RCD protection for the circuit.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Concealing Timber Defects & Ventilation Paths",
        control:
          "Inspect roof timbers for existing defects and maintain required roof ventilation paths before spraying, in line with current insulation guidance on spray foam risks.",
      },
      {
        name: "Equipment & Spray Gun Handling",
        control:
          "Check spray equipment, hoses and gun for damage before use, and follow the manufacturer's mixing ratios and pressure settings.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Noise Exposure from Hammering & Grinding",
        control:
          "Wear hearing protection during hammering, grinding and power tool use, and limit continuous exposure where practical.",
      },
      {
        name: "Compressed Gas & Fuel Handling (Forge)",
        control:
          "Store and handle forge fuel (gas or solid fuel) safely, checking hoses and connections for gas forges before lighting.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Damage to Vulnerable Surfaces & Pointing",
        control:
          "Adjust pressure and nozzle distance for the surface type, testing on an inconspicuous area first to avoid damaging soft pointing or block paving joints.",
      },
      {
        name: "Working Near Electrical Fittings & Outdoor Sockets",
        control:
          "Identify and avoid directing the water jet at outdoor electrical fittings, sockets or lighting during cleaning.",
      },
    ],
    required_ppe: [
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Entrapment & Safety Sensor Testing",
        control:
          "Test the door's auto-reverse/obstruction sensors before handover to confirm the door stops and reverses on contact with an obstruction.",
      },
      {
        name: "Working at Height for Header/Track Fixing",
        control:
          "Use a properly footed stepladder or podium when fixing header brackets and tracks above head height.",
      },
    ],
    required_ppe: [
      "Cut-Resistant Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Network & Wi-Fi Configuration Errors",
        control:
          "Test and confirm correct network configuration and device pairing before handover, avoiding leaving default or insecure credentials on installed systems.",
      },
      {
        name: "Working Near Existing Wiring & Fixtures",
        control:
          "Identify existing lighting circuits and wiring before integrating smart switches and dimmers, confirming compatibility before installation.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working on Sloped or Uneven Ground",
        control:
          "Assess ground stability and footing before working on sloped sites, using appropriate footwear and taking care when moving stone on uneven terrain.",
      },
      {
        name: "Weather Exposure During Prolonged Outdoor Work",
        control:
          "Wear appropriate weatherproof clothing and take regular breaks during prolonged exposure to wind, rain or sun on exposed sites.",
      },
    ],
    required_ppe: [
      "Cut-Resistant Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Biological & Hygiene Hazards in Neglected Properties",
        control:
          "Wear appropriate PPE and follow hygiene procedures when clearing properties with signs of pest infestation, mould or biological contamination.",
      },
      {
        name: "Waste Segregation & Legal Disposal",
        control:
          "Segregate waste for reuse, recycling and disposal correctly, using a licensed waste carrier for any hazardous or bulky items.",
      },
    ],
    required_ppe: [
      "Cut-Resistant Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Manoeuvring Appliances on Stairs & Through Doorways",
        control:
          "Assess the access route and use an appliance trolley or straps before attempting to move heavy appliances up stairs or through tight doorways.",
      },
      {
        name: "Old Appliance Removal & Disposal",
        control:
          "Disconnect and remove old appliances safely, disposing of them via a licensed WEEE-compliant waste carrier.",
      },
    ],
    required_ppe: [
      "Nitrile Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Slips & Falls on Curing Screed",
        control:
          "Barrier off and clearly sign the curing screed area to prevent anyone walking on it before it has sufficiently set.",
      },
      {
        name: "Working Near Underfloor Heating Pipework",
        control:
          "Confirm underfloor heating pipework has been pressure tested and is protected before screeding over it, avoiding damage from foot traffic or tools.",
      },
    ],
    required_ppe: [
      "Waterproof Cement-Resistant Gloves",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Gaps, Seals & Intumescent Strip Installation",
        control:
          "Check and fit intumescent strips and cold smoke seals to the door set's tested specification, confirming correct gaps around the leaf before sign-off.",
      },
      {
        name: "Recording Certification & Inspection Evidence",
        control:
          "Photograph and record the completed installation against the door set's certification, providing evidence for the building's fire safety records.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Maintaining Fire Compartmentation Alongside Acoustic Work",
        control:
          "Ensure acoustic treatment does not compromise existing fire-stopping or compartmentation, reinstating any fire seals disturbed during installation.",
      },
      {
        name: "Cutting & Fixing Acoustic Boards",
        control:
          "Use dust-extracted cutting tools for acoustic board products, and use correct fixings to avoid compromising the system's tested performance.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
  ...
  },
  {
    ...
    hazards: [
      ...
      {
        name: "Working Near Live Traffic in Car Parks",
        control:
          "Segregate the work area from live vehicle routes using barriers and signage while charge points and cabling are installed in car parks.",
      },
      {
        name: "Load Assessment & DNO Coordination",
        control:
          "Confirm the site's electrical supply capacity with the Distribution Network Operator (DNO) before installing high-power charging infrastructure, applying load management where required.",
      },
    ],
    required_ppe: [
      "1000V Insulated Gloves",
  ...
  {
    slug: "curtain-blind-fitter-curtain-pole-blind-installation",
    trade: "Curtains & Blinds",
    task_name: "Curtain Pole & Blind Installation",
    h1_title: "Curtain Pole & Blind Installation RAMS Generator (UK)",
    meta_description:
      "Create a site-specific RAMS for curtain pole and blind installation, covering working at height and power tool safety, in under 2 minutes.",
    applicable_regs: [
      "Work at Height Regulations 2005",
      "PUWER 1998",
      "Manual Handling Operations 1992",
    ...
    hazards: [
      {
        name: "Falls from Steps or Ladders When Fitting Poles/Tracks",
        control:
          "Use a properly footed stepladder or podium for fitting above head height, never overreaching or standing on furniture.",
      },
      {
        name: "Drilling into Walls & Ceilings (Hidden Services)",
        control:
          "Check for hidden pipework or wiring before drilling fixing points, wearing eye protection throughout.",
      },
      {
        name: "Manual Handling of Heavy Curtains, Poles & Motorised Blinds",
        control:
          "Use correct lifting technique for long curtain poles and heavy motorised blind units, particularly when working above stairwells.",
      },
      {
        name: "Motorised Blind Electrical Connection",
        control:
          "Isolate the local circuit before wiring hard-wired motorised blinds, and test dead before making any electrical connection.",
      },
      {
        name: "Child Safety Cord & Chain Compliance",
        control:
          "Fit cleats, cord tidies or breakaway devices to comply with BS EN 13120 child safety requirements for corded blinds.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
    ...
    faq_q1: "Does this RAMS cover the risk of drilling into hidden services when fitting curtain poles?",
    faq_a1:
      "Yes. It includes a control requiring a check for hidden pipework or wiring before drilling any fixing point for poles, tracks or brackets.",
  },
  {
    slug: "gate-automation-engineer-electric-gate-installation-automation",
    trade: "Electric Gates & Automation",
    task_name: "Electric Gate Installation & Automation",
    h1_title: "Electric Gate Installation & Automation RAMS Generator (UK)",
    meta_description:
      "Generate a site-specific RAMS for electric gate installation and automation, covering crush hazards and electrical safety, in 2 minutes.",
    applicable_regs: [
      "Electricity at Work Regulations 1989",
    ...
    hazards: [
      {
        name: "Crush & Trap Hazards from Moving Gate Leaves",
        control:
          "Fit and test safety edges, photocells and force-limiting devices before handover, confirming the gate meets the required safety standard (BS EN 12453) before commissioning.",
      },
      {
        name: "Electric Shock During Motor & Control Panel Wiring",
        control:
          "Isolate and lock off the supply before wiring gate motors and control panels, testing dead before making any connection.",
      },
      {
        name: "Manual Handling of Heavy Gate Leaves & Posts",
        control:
          "Use mechanical lifting aids or a minimum two-person team to position gate leaves and posts, supporting the structure fully during installation.",
      },
      {
        name: "Foundation & Post Excavation for Gate Posts",
        control:
          "Conduct a CAT & Genny scan before excavating for gate posts and foundations, and allow concrete foundations to fully cure before loading.",
      },
      {
        name: "Manual Override & Emergency Release",
        control:
          "Confirm the manual override/emergency release function operates correctly before handover, in case of power failure or fault.",
      },
    ],
    required_ppe: [
      "Cut-Resistant Gloves",
    ...
    faq_q1: "Does this RAMS cover the safety testing required for automated gates?",
    faq_a1:
      "Yes. It includes a control requiring safety edges, photocells and force-limiting devices to be fitted and tested against BS EN 12453 before the gate is commissioned and handed over.",
  },
  {
    slug: "loft-boarding-installer-loft-boarding-for-storage",
    trade: "Loft Boarding & Storage Solutions",
    task_name: "Loft Boarding for Storage",
    h1_title: "Loft Boarding for Storage RAMS Generator (UK)",
    meta_description:
      "Create a site-specific RAMS for loft boarding and storage solution installation, covering joist safety and confined space access, in under 2 minutes.",
    applicable_regs: [
      "Work at Height Regulations 2005",
      "Manual Handling Operations 1992",
      "COSHH Regulations 2002",
    ...
    hazards: [
      {
        name: "Falls Through Ceilings Between Joists",
        control:
          "Never step off joists or crawl boards directly onto ceiling material, identifying joist positions and existing insulation depth before laying boards.",
      },
      {
        name: "Manual Handling of Loft Boards & Raised Leg Battens",
        control:
          "Use a loft board conveyor or pass boards hand-to-hand up a properly footed ladder rather than carrying stacks singlehanded.",
      },
      {
        name: "Exposure to Existing Insulation Fibres",
        control:
          "Wear an FFP3 mask and gloves when moving or working around existing mineral wool insulation to lay raised-leg battens.",
      },
      {
        name: "Overloading Ceiling Joists with Storage Weight",
        control:
          "Confirm joist size and spacing before recommending raised-leg boarding, avoiding overloading ceiling joists not designed for storage loads.",
      },
      {
        name: "Existing Electrical Cabling in the Loft",
        control:
          "Identify and avoid existing electrical cabling when fitting battens and boards, reporting any damaged or exposed wiring found.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
    ...
    faq_q1: "Does this RAMS cover the risk of falling through the ceiling while boarding a loft?",
    faq_a1:
      "Yes. It includes a control requiring joist positions to be identified and crawl boards used before any boarding begins, preventing steps directly onto ceiling material.",
  },
  {
    slug: "basement-specialist-basement-conversion-tanking",
    trade: "Basement Conversion",
    task_name: "Basement Conversion & Tanking",
    h1_title: "Basement Conversion & Tanking RAMS Generator (UK)",
    meta_description:
      "Generate a site-specific, CDM 2015 compliant RAMS for basement conversion and tanking work, covering excavation and confined space hazards, in 2 minutes.",
    applicable_regs: [
      "CDM Regulations 2015",
      "Confined Spaces Regulations 1997",
      "Manual Handling Operations 1992",
    ...
    hazards: [
      {
        name: "Excavation & Underpinning Collapse Risk",
        control:
          "Excavate and underpin in short, engineer-designed sections, with each section supported before the next is opened, never leaving unsupported ground beneath a load-bearing wall.",
      },
      {
        name: "Working in a Confined Below-Ground Space",
        control:
          "Assess ventilation before entry and throughout the works, keeping a second person aware of the work location and using forced ventilation where needed.",
      },
      {
        name: "Exposure to Tanking Membrane & Waterproofing Chemicals",
        control:
          "Follow the COSHH data sheet for tanking slurries, membranes and adhesives, ensuring adequate ventilation during application.",
      },
      {
        name: "Groundwater Management During Excavation",
        control:
          "Use a sump pump or dewatering system to manage groundwater ingress during excavation, monitoring water levels throughout.",
      },
      {
        name: "Manual Handling in a Restricted Below-Ground Space",
        control:
          "Use mechanical aids or chutes for moving spoil and materials in and out of the basement excavation where headroom is restricted.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
    ...
    faq_q1: "Does this RAMS cover the underpinning risks involved in lowering a basement floor?",
    faq_a1:
      "Yes. It includes a control requiring excavation and underpinning to proceed in short, engineer-designed sections, with each section supported before the next is opened.",
  },
  {
    slug: "lightning-protection-engineer-lightning-protection-system-installation",
    trade: "Lightning Protection",
    task_name: "Lightning Protection System Installation",
    h1_title: "Lightning Protection System Installation RAMS Generator (UK)",
    meta_description:
      "Create a site-specific RAMS for lightning protection system installation, covering roof access and earthing safety, in under 2 minutes.",
    applicable_regs: [
    ...
    hazards: [
      {
        name: "Falls During Roof-Level Conductor Installation",
        control:
          "Use edge protection, roof anchor points or a harness system for all work at roof and ridge level, following the Work at Height Regulations 2005.",
      },
      {
        name: "Incorrect Earthing Leading to Ineffective Protection",
        control:
          "Test all earth electrode resistance values against the system design before sign-off, confirming continuity of the full down-conductor route.",
      },
      {
        name: "Manual Handling & Drilling for Conductor Fixings",
        control:
          "Wear eye protection when drilling fixing points into masonry or roof structures, and check for hidden services before drilling.",
      },
      {
        name: "Working Near Overhead Power Lines & Aerials",
        control:
          "Identify and maintain safe clearance from overhead power lines and other roof-mounted services when routing conductor tape.",
      },
      {
        name: "Weather Conditions Affecting Roof Access",
        control:
          "Monitor wind speed and weather forecasts throughout the day, and stop roof-level work if conditions make access unsafe.",
      },
    ],
    required_ppe: [
      "Fall Arrest Harness (BS EN 361)",
    ...
    faq_q1: "Does this RAMS cover the earth resistance testing required for lightning protection systems?",
    faq_a1:
      "Yes. It includes a control requiring earth electrode resistance values to be tested against the system design and full down-conductor continuity confirmed before sign-off, in line with BS EN 62305.",
  },
  {
    slug: "radon-specialist-radon-mitigation-system-installation",
    trade: "Radon Mitigation",
    task_name: "Radon Mitigation System Installation",
    h1_title: "Radon Mitigation System Installation RAMS Generator (UK)",
    meta_description:
      "Generate a site-specific RAMS for radon mitigation system installation, covering sub-floor access and radon gas exposure, in 2 minutes.",
    applicable_regs: [
    ...
    hazards: [
      {
        name: "Radon Gas Exposure During Sub-Floor Works",
        control:
          "Ventilate the work area throughout sump installation and testing, minimising time spent in unventilated sub-floor voids and following the radon action plan for the property.",
      },
      {
        name: "Working in Confined Sub-Floor & Crawl Spaces",
        control:
          "Assess access and ventilation before entering sub-floor voids, keeping a second person aware of the work location throughout.",
      },
      {
        name: "Power Tool Use When Breaking Through Floor Slabs",
        control:
          "Use dust extraction on cutting equipment when forming the sump pit, and wear an FFP3 mask throughout.",
      },
      {
        name: "Fan Unit Electrical Installation",
        control:
          "Install and wire the radon sump fan to a fused spur or dedicated circuit in line with BS 7671, positioning it for accessible future maintenance.",
      },
      {
        name: "Post-Installation Radon Testing",
        control:
          "Confirm system effectiveness with a follow-up radon test after installation, in line with UK Health Security Agency guidance.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
    ...
    faq_q1: "Does this RAMS cover radon gas exposure risks specific to sub-floor work?",
    faq_a1:
      "Yes. It includes a control requiring the work area to be ventilated throughout sump installation, minimising time spent in unventilated sub-floor voids.",
  },
  {
    slug: "ewi-installer-external-wall-insulation-installation",
    trade: "External Wall Insulation (EWI)",
    task_name: "External Wall Insulation (EWI) Installation",
    h1_title: "External Wall Insulation (EWI) Installation RAMS Generator (UK)",
    meta_description:
      "Create a site-specific RAMS for external wall insulation (EWI) installation, covering scaffold access and fire safety of the render system, in under 2 minutes.",
    applicable_regs: [
      "Work at Height Regulations 2005",
      "Building Regulations Approved Document B (Fire Safety)",
      "COSHH Regulations 2002",
    ...
    hazards: [
      {
        name: "Falls from Scaffold During Board Fixing & Rendering",
        control:
          "Use a properly erected scaffold with guardrails for all EWI fixing and finishing above 2m, checking the handover tag before first use each day.",
      },
      {
        name: "Fire Safety of the Insulation & Render System",
        control:
          "Install fire breaks and cavity barriers strictly to the specified system build-up, particularly around openings and at each floor level, and confirm the system's fire classification matches the building's requirements.",
      },
      {
        name: "Exposure to Render & Adhesive Dust/Chemicals",
        control:
          "Follow the COSHH data sheet for basecoat, adhesive and render products, wearing appropriate RPE when mixing or sanding.",
      },
      {
        name: "Weather Sensitivity of Basecoat & Render Application",
        control:
          "Check temperature and rainfall forecasts before applying basecoat or render, avoiding application in frost or immediately before heavy rain.",
      },
      {
        name: "Manual Handling of Insulation Boards & Render Bags",
        control:
          "Use mechanical lifting aids for insulation board bundles and render bags moved up scaffold access, team-lifting where mechanical aids aren't practical.",
      },
    ],
    required_ppe: [
      "BS EN 397 Hard Hat",
    ...
    faq_q1: "Does this RAMS cover the fire safety requirements for EWI systems?",
    faq_a1:
      "Yes. It includes a control requiring fire breaks and cavity barriers to be installed strictly to the specified system build-up, reflecting increased regulatory scrutiny on external wall insulation systems.",
  },
  {
    slug: "biomass-engineer-biomass-boiler-installation",
    trade: "Biomass Heating",
    task_name: "Biomass Boiler Installation",
    h1_title: "Biomass Boiler Installation RAMS Generator (UK)",
    meta_description:
      "Generate a site-specific RAMS for biomass boiler installation, covering fuel storage and flue safety, in 2 minutes.",
    applicable_regs: [
      "Gas Safety (Installation and Use) Regulations 1998",
      "HETAS Installation Standards",
      "Manual Handling Operations 1992",
    ...
    hazards: [
      {
        name: "Fire Risk from Fuel Storage & Handling",
        control:
          "Install fuel stores and augers to the manufacturer's clearance and fire separation requirements, keeping ignition sources away from pellet or woodchip storage areas.",
      },
      {
        name: "Carbon Monoxide & Flue Gas Exposure",
        control:
          "Check flue integrity, terminal clearances and combustion performance using a calibrated analyser before leaving the appliance in use.",
      },
      {
        name: "Manual Handling of Boiler Unit & Fuel Store Components",
        control:
          "Two-person lift or mechanical aid for the boiler body and fuel store hoppers, using correct lifting technique throughout.",
      },
      {
        name: "Auger & Moving Parts of the Fuel Feed System",
        control:
          "Isolate and lock off the fuel feed auger before any maintenance or clearing of blockages, keeping hands and clothing clear of moving parts.",
      },
      {
        name: "Ash Removal & Hot Residue Handling",
        control:
          "Allow ash to cool fully before removal, storing it in a metal container away from combustible materials.",
      },
    ],
    required_ppe: [
      "FFP2 Dust Mask",
    ...
    faq_q1: "Does this RAMS cover the fire risk from pellet or woodchip fuel storage?",
    faq_a1:
      "Yes. It includes a control requiring fuel stores and augers to be installed to the manufacturer's clearance and fire separation requirements, keeping ignition sources clear of storage areas.",
  },
  {
    slug: "heat-pump-installer-ground-air-source-heat-pump-installation",
    trade: "Heat Pump Installation",
    task_name: "Ground & Air Source Heat Pump Installation",
    h1_title: "Ground & Air Source Heat Pump Installation RAMS Generator (UK)",
    meta_description:
      "Create a site-specific RAMS for ground and air source heat pump installation, covering excavation, refrigerant and electrical safety, in under 2 minutes.",
    applicable_regs: [
      "F-Gas Regulations 2015",
      "Electricity at Work Regulations 1989",
      "Manual Handling Operations 1992",
    ...
    hazards: [
      {
        name: "Striking Buried Services During Ground Loop Excavation",
        control:
          "Conduct a CAT & Genny scan and consult utility drawings before excavating for ground loop trenches or boreholes.",
      },
      {
        name: "Refrigerant Handling During Commissioning",
        control:
          "Only F-Gas certified engineers to handle refrigerant, using recovery equipment and checking for leaks before and after commissioning.",
      },
      {
        name: "Electric Shock During Unit Wiring & Commissioning",
        control:
          "Isolate and lock off the circuit before wiring the outdoor/indoor unit, testing dead using a proved voltage indicator before any electrical connection.",
      },
      {
        name: "Noise Assessment for Air Source Outdoor Units",
        control:
          "Position the outdoor unit in line with MCS noise assessment requirements to avoid statutory nuisance to neighbouring properties.",
      },
      {
        name: "Manual Handling of Ground Loop Pipe & Header Units",
        control:
          "Use mechanical lifting aids for ground loop pipe coils and header units, team-lifting where mechanical aids aren't practical.",
      },
    ],
    required_ppe: [
      "BS EN 166 Safety Glasses",
    ...
    faq_q1: "Does this RAMS cover the ground loop excavation risks for ground source heat pumps?",
    faq_a1:
      "Yes. It includes a CAT & Genny scanning control before any excavation for ground loop trenches or boreholes, alongside refrigerant handling controls common to both ground and air source systems.",
  },
  {
    slug: "sash-window-restorer-timber-sash-window-restoration-draught-proofing",
    trade: "Sash Window Restoration",
    task_name: "Timber Sash Window Restoration & Draught-Proofing",
    h1_title: "Timber Sash Window Restoration & Draught-Proofing RAMS Generator (UK)",
    meta_description:
      "Generate a site-specific RAMS for timber sash window restoration and draught-proofing, covering glass handling and lead paint exposure, in 2 minutes.",
    applicable_regs: [
      "COSHH Regulations 2002",
      "Manual Handling Operations 1992",
      "Work at Height Regulations 2005",
    ...
    hazards: [
      {
        name: "Exposure to Lead-Based Paint on Older Sashes",
        control:
          "Assume older paintwork may contain lead unless tested otherwise, using wet-sanding or chemical stripping rather than dry sanding, and wearing appropriate RPE.",
      },
      {
        name: "Cuts from Handling Old & Replacement Glass",
        control:
          "Use glass-handling gloves when removing old glazing putty and panes, carrying glass vertically and disposing of broken glass safely.",
      },
      {
        name: "Falls While Working on Upper-Floor Sash Windows",
        control:
          "Use an appropriate tower or MEWP for upper-floor sash restoration, with ladders restricted to short-duration ground floor work only.",
      },
      {
        name: "Manual Handling of Sash Weights & Cords",
        control:
          "Support the sash securely before accessing the weight box, and use correct lifting technique when handling heavy cast iron sash weights.",
      },
      {
        name: "Timber Decay & Structural Condition of the Frame",
        control:
          "Assess the frame for rot or structural decay before restoration work begins, and repair or splice affected timber before refitting sashes.",
      },
    ],
    required_ppe: [
      "FFP3 Dust Mask",
    ...
    faq_q1: "Does this RAMS cover the risk of lead paint on older sash windows?",
    faq_a1:
      "Yes. It includes a control requiring older paintwork to be assumed to contain lead unless tested otherwise, with wet-sanding or chemical stripping used in place of dry sanding.",
  },
];
